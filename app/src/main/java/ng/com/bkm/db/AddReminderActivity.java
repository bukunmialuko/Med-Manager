...
import ng.com.bkm.db.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private EditText mTitleDesc;
    private TextView mDateText,mEndDateText, mTimeText, mRepeatText, mRepeatNoText, mRepeatTypeText;
    private FloatingActionButton mFAB1;
    private FloatingActionButton mFAB2;
    private Calendar mCalendar;
    private int mYear, mMonth, mHour, mMinute, mDay, mEndYear, mEndMonth, mEndDay ;
    ...
    private Uri mEndReminderUri;
    private boolean mVehicleHasChanged = false;

    // Values for orientation change
    private static final String KEY_TITLE = "title_key";
    private static final String KEY_DESCRIPTION = "title_description";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleDesc = (EditText) findViewById(R.id.description); //fix
        mDateText = (TextView) findViewById(R.id.set_date);
        mEndDateText = (TextView) findViewById(R.id.set_end_date); //fix
        ...
        if (savedInstanceState != null) {
            ...
            String savedDesc = savedInstanceState.getString(KEY_DESCRIPTION);
            mTitleDesc.setText(savedDesc);
            mDesc = savedDesc;
            ...
            mEndDateText.setText(savedEndDate);
            mEndDate = savedEndDate;
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_DESCRIPTION, mTitleDesc.getText());
        outState.putCharSequence(KEY_TIME, mTimeText.getText());
        outState.putCharSequence(KEY_DATE, mDateText.getText());
        outState.putCharSequence(KEY_END_DATE, mEndDateText.getText());
...
*/
        ...
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_DESCRIPTION, mDesc);
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_DATE, mDate);
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_END_DATE, mEndDate);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                AlarmReminderContract.AlarmReminderEntry.KEY_END_DATE,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int endDateColumnIndex = cursor.getColumnIndex(AlarmReminderContract.AlarmReminderEntry.KEY_END_DATE);
            ...
            mTitleDesc.setText(description);

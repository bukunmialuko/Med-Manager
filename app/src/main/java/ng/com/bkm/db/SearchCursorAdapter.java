...
public class SearchCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.search_items, parent, false);
    }

    @Override
    public void bindView(View view, Context context, Cursor cursor) {

        mTitleText = (TextView) view.findViewById(R.id.search_recycle_title);
        mDateAndTimeText = (TextView) view.findViewById(R.id.search_recycle_date_time);
        mRepeatInfoText = (TextView) view.findViewById(R.id.search_recycle_repeat_info);
        mActiveImage = (ImageView) view.findViewById(R.id.search_active_image);
        mThumbnailImage = (ImageView) view.findViewById(R.id.search_thumbnail_image);
